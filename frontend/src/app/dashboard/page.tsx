              ...
              {user?.role === "tenant" && (
                <>
                  ...
                  <div className="mb-6 bg-white/80 dark:bg-gray-800/80 rounded-xl p-6 shadow-lg flex flex-col items-center">
                    ...
                    <button className="mt-2 px-6 py-2 rounded-lg bg-orange-500 dark:bg-orange-600 text-white font-medium hover:bg-orange-600 dark:hover:bg-orange-700 transition-colors">طلب الصيانة <i className="fa fa-wrench" aria-hidden="true"></i></button>
                  </div>
                  {/* قسم العقود */}
