...
export default function BookingRequestsPage() {
  ...
  const handleReject = async (bookingId: string) => {
    if (!window.confirm("هل أنت متأكد أنك تريد رفض هذا الطلب؟ سيتم حذف الطلب نهائياً.")) return;
    try {
      await apiService.rejectBookingRequest(bookingId);
      toast.success("تم رفض الطلب وحذفه بنجاح.");
